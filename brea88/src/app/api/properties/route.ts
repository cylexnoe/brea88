...
function cleanString(
  ...
  return cleaned && cleaned.length <= maxLength
    ? cleaned
    : null;
}
      ...
      error: NextResponse.json(
        {
          success: false,
          message:
            'Assigned Agent or Broker does not exist.',
        },
        {
          status: 400,
        },
      ...
      error: NextResponse.json(
        {
          success: false,
          message:
            'Cannot assign a property to an inactive account.',
        },
        {
          status: 400,
        },
...
function parsePropertyBody(
  ...
  if (
    ...
    return {
      error:
        'Property image URL must use HTTPS.',
    };
  }
  ...
  if (
    ...
    return {
      error:
        'Property video URL must use HTTPS.',
    };
  }
...
/* ============================================================
 * POST PROPERTY / DUPLICATE PROPERTY
 * ============================================================ */
