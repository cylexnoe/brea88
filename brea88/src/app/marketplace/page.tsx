        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-10 pt-16 sm:px-6 lg:px-8">
          ...
          <Reveal delay={180}>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100/70 sm:text-base">
              Browse available properties and find a place that fits your
            ...
            <div className="mt-3 flex gap-2 overflow-x-auto pb-1">
              {PROPERTY_CATEGORIES.map((category) => (
                <button
                  ...
                  className={`whitespace-nowrap rounded-xl border px-4 py-2.5 text-xs font-black transition ${
                    selectedCategory === category
                      ? 'border-blue-600 bg-gradient-to-r from-blue-800 to-blue-600 text-white shadow-lg'
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
              <div>
                ...
                <select
                  ...
                  className="h-12 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(event) =>
                    setSelectedStorey(event.target.value)
                  }
                  className="h-12 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                >
                  ...
                  {STOREY_OPTIONS.map((storey) => (
                    <option key={storey} value={storey}>
                      {storey === '4+' ? '4 or more' : `${storey} Storey`}
                    </option>
                  ))}
                </select>
              </div>
            ...
            {filtersApplied && (
              <div className="mt-5 flex items-center justify-between border-t border-slate-100 pt-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-black text-slate-500 transition hover:bg-blue-50 hover:text-blue-800"
                >
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
                Browse our available properties and discover a place that fits
          ...
          <Reveal>
            <div className="mx-auto max-w-lg rounded-[1.75rem] border border-slate-200 bg-white px-6 py-16 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Try changing your search, property category, property type,
