  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050b18] px-4 py-8 text-white sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <section
          className="tv-cards grid grid-cols-2 gap-3 sm:gap-5 md:gap-6"
        ...
        >
          ...
          >
            ...
            <div className="relative">
              <div className="mb-4 flex items-start justify-between sm:mb-6">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-800 text-white shadow-lg shadow-blue-950/40 transition-transform duration-300 group-hover:scale-105 sm:h-14 sm:w-14 md:h-16 md:w-16 md:rounded-2xl">
                  <Users className="h-5 w-5 sm:h-7 sm:w-7 md:h-8 md:w-8" />
                </div>

                <span className="rounded-full border border-white/15 bg-white/5 px-2 py-1 text-[8px] font-bold uppercase tracking-[.15em] text-slate-300 sm:px-3 sm:text-[10px]">
                  Client
                </span>
              </div>

              <p className="mb-1 text-[8px] font-bold uppercase tracking-wider text-blue-300 sm:mb-2 sm:text-xs sm:tracking-widest">
                Looking For Property
              </p>

              <h2 className="text-base font-black leading-tight text-white sm:text-2xl md:text-3xl">
                I’m a Client
              </h2>

              <div className="mt-5 flex items-center justify-between gap-2 border-t border-white/10 pt-4 sm:mt-8 sm:pt-5">
                <span className="text-[10px] font-bold leading-tight text-blue-100 sm:text-sm md:text-base">
                  Browse Properties
                </span>

                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white transition-all duration-300 group-hover:translate-x-1 group-hover:bg-[#c9a96e] group-hover:text-[#071936] sm:h-10 sm:w-10">
          ...
          <button
            ...
            className="group relative min-w-0 overflow-hidden rounded-2xl border border-[#c9a96e]/20 bg-gradient-to-br from-[#0b2348]/90 via-[#071936]/85 to-[#040d20]/95 p-4 text-left shadow-2xl shadow-blue-950/30 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-1 hover:border-blue-300/60 hover:bg-indigo-950/60 hover:shadow-blue-700/40 active:scale-[.98] sm:rounded-3xl sm:p-7 md:p-10"
          >
            ...
            <div className="relative">
              <div className="mb-4 flex items-start justify-between sm:mb-6">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white text-[#071936] shadow-lg transition-transform duration-300 group-hover:scale-105 sm:h-14 sm:w-14 md:h-16 md:w-16 md:rounded-2xl">
                  <BriefcaseBusiness className="h-5 w-5 sm:h-7 sm:w-7 md:h-8 md:w-8" />
                </div>

                <span className="rounded-full border border-[#ead9b8]/20 bg-white/5 px-2 py-1 text-[8px] font-bold uppercase tracking-[.15em] text-[#ead9b8] sm:px-3 sm:text-[10px]">
                  Professional
                </span>
              </div>

              <p className="mb-1 text-[8px] font-bold uppercase tracking-wider text-[#ead9b8] sm:mb-2 sm:text-xs sm:tracking-widest">
              ...
              <div className="mt-5 flex items-center justify-between gap-2 border-t border-white/10 pt-4 sm:mt-8 sm:pt-5">
                <span className="text-[10px] font-bold leading-tight text-white sm:text-sm md:text-base">
                  Agent Login
                </span>

                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white transition-all duration-300 group-hover:translate-x-1 group-hover:bg-[#ead9b8] group-hover:text-[#071936] sm:h-10 sm:w-10">
                  <ArrowRight className="h-3.5 w-3.5 sm:h-5 sm:w-5" />
                </span>
              </div>
            </div>
      ...
      <style jsx>{`
        ...
        @keyframes liquidOne {
          ...
          50% {
            transform: translate3d(130px, 60px, 0) scale(1.12);
          }
        }
        ...
        @keyframes liquidTwo {
          ...
          50% {
            transform: translate3d(-100px, 120px, 0) scale(1.15);
          }
        }
        ...
        @keyframes liquidThree {
          ...
          50% {
            transform: translate3d(150px, -80px, 0) scale(1.1);
          }
        }
        ...
        .blob-four {
          animation: liquidFour 15s ease-in-out infinite;
        }
        ...
        .tv-cards {
          ...
          animation: tvScreenOn 1.15s cubic-bezier(0.16, 1, 0.3, 1)
            both;
          position: relative;
        }
        ...
        .tv-cards::before {
          ...
          pointer-events: none;
          z-index: 50;
          animation: tvLine 0.5s ease-out 0.08s both;
        }
        ...
        .tv-cards::after {
          ...
          pointer-events: none;
          z-index: 40;
          animation: tvFlash 0.75s ease-out 0.15s both;
        }

        @keyframes tvScreenOn {
          0% {
            opacity: 0;
            transform: scaleY(0.015) scaleX(0.82);
            filter: brightness(3) blur(1px);
          }

          12% {
            opacity: 1;
            transform: scaleY(0.035) scaleX(0.9);
            filter: brightness(4) blur(0.8px);
          }

          32% {
            transform: scaleY(0.22) scaleX(0.96);
            filter: brightness(2.2) blur(0.3px);
          }

          55% {
            transform: scaleY(0.72) scaleX(0.99);
        ...
        /* Slight individual separation as the TV screen expands */

        .tv-cards > button:first-child {
          animation: cardLeftOn 1.15s cubic-bezier(0.16, 1, 0.3, 1)
            both;
        }

        .tv-cards > button:last-child {
          animation: cardRightOn 1.15s cubic-bezier(0.16, 1, 0.3, 1)
            both;
        }

        @keyframes cardLeftOn {
          0% {
            opacity: 0;
            transform: translateX(10px) scaleY(0.02);
            filter: brightness(2.5);
          }

          35% {
            opacity: 1;
            transform: translateX(4px) scaleY(0.3);
